--[[
 ...
 NOTE: The Only Video You Need to Get Started with Neovim
...
-- except the current line, which shows its absolute number
vim.o.number = true
...
require('lazy').setup({
    ...
    dependencies = {
      -- Snippet Engine
      {
        ...
        dependencies = {
          ...
          --    https:/ithub.com/rafamadriz/friendly-snippets
          {
  ...
  --  TODO: disbale the tokyonight theme, enable catppuccin instead.
